...
# Cofre de Senhas — Backlog do Produto
...
| BLG-0102 | DONE    | `@vault/tsconfig` com `strict`, `noUncheckedIndexedAccess` e `exactOptionalPropertyTypes`; aliases configurados. |
| BLG-0103 | DONE    | `@vault/eslint-config` (flat config) com variantes React e Nest; Prettier na raiz.                               |
